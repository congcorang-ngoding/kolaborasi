        ...
        <ul class="navbar-nav navbar-nav-icons flex-row">
                    ...
                    <div class="card position-relative border-0">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between position-relative">
                                        <div class="d-flex">
                                            <div class="avatar avatar-m status-online me-3"><img
                                                    ...
                                                    src="{{ asset('backend') }}/assets/img/team/40x40/30.webp"
                                                    alt="" />
                                            </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between position-relative">
                                        <div class="d-flex">
                                            <div class="avatar avatar-m status-online me-3"><img
                                                    ...
                                                    src="{{ asset('backend') }}/assets/img/team/40x40/avatar.webp"
                                                    alt="" />
                                            </div>
                                            <div class="flex-1 me-sm-3">
                                                <h4 class="fs-9 text-body-emphasis">Jessie Samson</h4>
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center justify-content-between position-relative">
                                        <div class="d-flex">
                                            <div class="avatar avatar-m status-online me-3"><img
                                                    class="rounded-circle"
                                                    src="{{ asset('backend') }}/assets/img/team/40x40/57.webp"
                                                    alt="" />
                                            </div>
                                            <div class="flex-1 me-sm-3">
                                ...
                                <div
                                    ...
                                    <div class="d-flex align-items-center justify-content-between position-relative">
                                        <div class="d-flex">
                                            <div class="avatar avatar-m status-online me-3"><img
                                                    class="rounded-circle"
                                                    src="{{ asset('backend') }}/assets/img/team/40x40/59.webp"
                                                    alt="" />
                                            </div>
                                            <div class="flex-1 me-sm-3">
                                ...
                                <div class="px-2 px-sm-3 py-3 notification-card position-relative read ">
                                    <div class="d-flex align-items-center justify-content-between position-relative">
                                        <div class="d-flex">
                                            <div class="avatar avatar-m status-online me-3"><img
                                                    class="rounded-circle"
                                                    src="{{ asset('backend') }}/assets/img/team/40x40/58.webp"
                                                    alt="" />
                                            </div>
                                            <div class="flex-1 me-sm-3">
                        ...
                        <div class="card-footer p-0 border-top border-translucent border-0">
                            <div class="my-2 text-center fw-bold fs-10 text-body-tertiary text-opactity-85"><a
                                    class="fw-bolder"
                                    href="{{ asset('backend') }}/pages/notifications.html">Notification history</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body pt-3 px-3 pb-0 overflow-auto scrollbar" style="height: 20rem;">
                            <div class="row text-center align-items-center gx-0 gy-0">
                                <div class="col-4"><a
                                        ...
                                        href="#!"><img
                                            src="{{ asset('backend') }}/assets/img/nav-icons/behance.webp"
                                            alt="" width="30" />
                                ...
                                <div class="col-4"><a
                                        class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('backend') }}/assets/img/nav-icons/google-cloud.webp"
                                            alt="" width="30" />
                                ...
                                <div class="col-4"><a
                                        class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('backend') }}/assets/img/nav-icons/slack.webp"
                                            alt="" width="30" />
                                ...
                                <div class="col-4"><a
                                        class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('backend') }}/assets/img/nav-icons/gitlab.webp"
                                            alt="" width="30" />
                                ...
                                <div class="col-4"><a
                                        class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('backend') }}/assets/img/nav-icons/bitbucket.webp"
                                            alt="" width="30" />
                                ...
                                <div class="col-4"><a
                                        class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('backend') }}/assets/img/nav-icons/google-drive.webp"
                                            alt="" width="30" />
                                ...
                                <div class="col-4"><a
                                        class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('backend') }}/assets/img/nav-icons/trello.webp"
                                            alt="" width="30" />
                                ...
                                <div class="col-4"><a
                                        class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('backend') }}/assets/img/nav-icons/figma.webp"
                                            alt="" width="20" />
                                ...
                                <div class="col-4"><a
                                        class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('backend') }}/assets/img/nav-icons/twitter.webp"
                                            alt="" width="30" />
                                ...
                                <div class="col-4"><a
                                        class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('backend') }}/assets/img/nav-icons/pinterest.webp"
                                            alt="" width="30" />
                                        <p class="mb-0 text-body-emphasis text-truncate fs-10 mt-1 pt-1">Pinterest</p>
                                    </a></div>
                                <div class="col-4"><a
                                        class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img src="{{ asset('backend') }}/assets/img/nav-icons/ln.webp"
                                            alt="" width="30" />
                                ...
                                <div class="col-4"><a
                                        class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('backend') }}/assets/img/nav-icons/google-maps.webp"
                                            alt="" width="30" />
                                ...
                                <div class="col-4"><a
                                        class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('backend') }}/assets/img/nav-icons/google-photos.webp"
                                            alt="" width="30" />
                                ...
                                <div class="col-4"><a
                                        class="d-block bg-body-secondary-hover p-2 rounded-3 text-center text-decoration-none mb-3"
                                        href="#!"><img
                                            src="{{ asset('backend') }}/assets/img/nav-icons/spotify.webp"
                                            alt="" width="30" />
            ...
            <li class="nav-item dropdown"><a class="nav-link lh-1 pe-0" id="navbarDropdownUser" href="#!"
                    ...
                    <div class="avatar avatar-l ">
                        <img class="rounded-circle " src="{{ asset('backend') }}/assets/img/team/40x40/57.webp"
                            alt="" />
                        ...
                        <div class="card-body p-0">
                            <div class="text-center pt-4 pb-3">
                                <div class="avatar avatar-xl ">
                                    <img class="rounded-circle "
                                        src="{{ asset('backend') }}/assets/img/team/72x72/57.webp" alt="" />
